 ...
 * The trait GameDef will contain all the logic regarding how the terrain is setup,
 * the blocks are represented and how they move.
 */
trait GameDef {
   ...
   *   row axis
   */
  case class Pos(row: Int, col: Int): //In short this position on the game board
   ...
   */
  def startPos: Pos //pos contain both the row and col
